$(document).ready(function () {
    ...
    $("#btnle").click(function () {
        ...
        if (flag == true) {
            ...
            window.location.href = "/task/task2/home/task2.html";
        }
    });
    ...
    $("#btnrig").click(function () {
        ...
        window.location.href = "/task/task3/judge/judge.html";
    });
    ...
    if (parseInt(sessionStorage.getItem("orlmNumber")) <= parseInt(sessionStorage.getItem("killerNumber"))) {
        ...
        voteRtn();
        window.location.href = "/task/task4/result/result.html";
    }
    ...
    $(".kill").click(function () {
        ...
        alert("天黑请闭眼。")
        window.location.href = "/task/task3/killer/killer.html";
    });
    //亡灵发言按钮
...
function BackOff() {
    ...
    if (b == true) {
        ...
        window.location.href = "/task/task2/parameter/parameter.html";
    }
}
